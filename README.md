# LUN3CY FAN - Personal Website

一个以内容数据驱动的个人作品集网站，包含主页、作品集与联系页，集成摄影/摄像/设计/开发作品展示，以及内置音乐播放器与物理“爆炸”彩蛋。
...
2. 作品集筛选：按分类过滤（摄影 / 动态影像 / 平面交互 / 应用开发），支持从主页“标题点击”直接带筛选跳转
3. 项目详情弹窗：Portal 模态框展示作品详情与媒体内容（图片/视频/Bilibili/Figma/外链网站 iframe），附 GitHub/站点链接
4. 摄影图库预览：图片网格 + Lightbox，支持键盘左右切换/ESC 关闭与移动端滑动切换
